...
function Home() {
  const t = useT();
  const steps = [
    { n: "01", label: t("home.step1") },
    { n: "02", label: t("home.step2") },
    { n: "03", label: t("home.step3") },
  ];
  const guides = [
    { n: "01", title: t("home.guideHowTitle"), copy: t("home.guideHowCopy"), href: "/how-it-works" as const },
    { n: "02", title: t("home.guideSupportTitle"), copy: t("home.guideSupportCopy"), href: "/support" as const },
    { n: "03", title: t("home.guideRefundTitle"), copy: t("home.guideRefundCopy"), href: "/refund-policy" as const },
  ];
    ...
    <SiteChrome>
            ...
            <aside className="hidden lg:block">
              <div className="ledger-in rounded-xl bg-secondary/80 p-6 shadow-[var(--shadow-border)]">
                <div className="flex items-center justify-between border-b border-border pb-3">
                  <span className="kicker">{t("home.picker")}</span>
      ...
      <section id="plans" className="page-wrap scroll-mt-24 py-12 sm:py-16">
        <div className="mb-9 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            <p className="kicker">{t("home.shopKicker")}</p>
            <h2 className="display mt-2 text-3xl">{t("home.shopTitle")}</h2>
          </div>
        ...
        >
          <p className="kicker">{t("home.referralKicker")}</p>
          <h3 className="mt-2 font-display text-2xl tracking-[-0.03em]">{t("home.referralTitle")}</h3>
      ...
      <section className="border-y border-border bg-secondary/60 py-14 sm:py-16">
        <div className="page-wrap grid gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-end lg:gap-20">
          <div>
            <p className="kicker">{t("home.guideKicker")}</p>
            <h2 className="display mt-3 max-w-sm text-3xl">{t("home.guideTitle")}</h2>
